...
```
Устройство      Read UUID                                Write UUID
--------------------------------------------------------------------------------
AdEM Key        6e400003-b5a3-f393-e0a9-e50e24dcca9e     6e400002-b5a3-f393-...
Air Console     0f1e4b13-16d2-4396-bf25-000000000001     (same as read)
```
...
RS         -      Чтение локации
RI         -      Чтение ID клиента
WS         -      Запись локации
WI         -      Запись ID клиента
RM         -      Ежедневный лог
RE         -      Лог событий
DD         -      Интервальный лог
RL         -      Лог аварий
RQ         -      Q-лог
RF         -      Лог перепада давления
CA         -      Смена кода доступа
CC         -      Смена супер-кода
SF         -      Разрыв соединения
```
