...
import 'calibration_3_point_dp_page_bloc.dart';
import 'calibration_3_point_decoration.dart';

class Calibration3PointDpPage extends StatefulWidget {
  const Calibration3PointDpPage({super.key});

  @override
  State<Calibration3PointDpPage> createState() =>
      _Calibration3PointDpPageState();
}

class _Calibration3PointDpPageState extends State<Calibration3PointDpPage>
    with CalibrationManager, AccessCodeHelper {
  late final _bloc = BlocProvider.of<Calibration3PointDpPageBloc>(context);
          ...
          child: GestureDetector(
            ...
            child: Scaffold(
              appBar: SAppBar.withSubmit(
                ...
                subText: locale.threePointString,
                ...
                child: isDataReady
                    ? Form(
                        ...
                        child: Calibration3PointDecoration(
                          ...
                          type: CalibrationItem.dp3Point,
                          count: _fetchCount,
                          param: Param.diffPress,
                          limit: Param.threePtDpCalibParams.limit(_adem),
