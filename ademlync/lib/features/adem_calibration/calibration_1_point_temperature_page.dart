...
import 'calibration_1_point_temperature_page_bloc.dart';
import 'calibration_1_point_decoration.dart';

class Calibration1PointTemperaturePage extends StatefulWidget {
  const Calibration1PointTemperaturePage({super.key});

  @override
  State<Calibration1PointTemperaturePage> createState() =>
      _Calibration1PointTemperaturePageState();
}

class _Calibration1PointTemperaturePageState
    extends State<Calibration1PointTemperaturePage>
    with AccessCodeHelper {
  late final _bloc = BlocProvider.of<Calibration1PointTemperaturePageBloc>(
    context,
  );
                ...
                child: isDataReady
                    ? Form(
                        ...
                        child: Calibration1PointDecoration(
                          ...
                          param: Param.temp,
                          limit: Param.tempCalib1PtOffset.limit(
                            AppDelegate().adem,
                          ),
                          count: _fetchCount,
                          reading: _info!.temp,
