...
import 'calibration_3_point_pressure_page_bloc.dart';
import 'calibration_3_point_decoration.dart';

class Calibration3PointPressurePage extends StatefulWidget {
  const Calibration3PointPressurePage({super.key});

  @override
  State<Calibration3PointPressurePage> createState() =>
      _Calibration3PointPressurePageState();
}

class _Calibration3PointPressurePageState
    extends State<Calibration3PointPressurePage>
    with AccessCodeHelper, CalibrationManager {
  late final _bloc = BlocProvider.of<Calibration3PointPressurePageBloc>(
    context,
  );
  ...
  AdemParamLimit? get _limit {
    final limit = Param.threePtPressCalibParams.limit(_adem);
                ...
                child: isDataReady
                    ? Form(
                        ...
                        child: Calibration3PointDecoration(
                          ...
                          type: CalibrationItem.press3Point,
                          count: _fetchCount,
                          param: _param,
                          limit: _limit,
